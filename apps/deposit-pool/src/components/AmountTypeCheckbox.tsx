...
//           disabled
//             ? "flex items-center"
//             : "flex items-center hover:text-primary [&>div>svg>circle#circle1]:hover:fill-primary [&>div>svg>circle#circle3]:hover:fill-primary"
//         }
//       >
//         <div
//           className={
//             disabled
//               ? "relative p-1 cursor-default"
...
//         <span
//           className={
//             disabled ? "cursor-default mr-2 opacity-70" : "cursor-pointer mr-2"
//           }
//         >
//           {label}
//         </span>
//         {tooltip && <InfoTooltip text={tooltip} className="opacity-100" />}
//       </Label>
